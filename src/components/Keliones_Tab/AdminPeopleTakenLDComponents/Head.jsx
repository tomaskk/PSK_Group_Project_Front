...
class Head extends Component {
  ...
  getSorting(order, orderBy) {
    return order === false ? (a, b) => this.desc(a, b, orderBy) : (a, b) => -this.desc(a, b, orderBy);
  }
  ...
  onSort(e, orderBy){
    ...
    if(orderBy=='')
      return;
    let newUsers = this.stableSort(this.props.filteredUsers, this.getSorting(order, orderBy))
    let sortedUsers = this.stableSort(this.props.sortedUsers, this.getSorting(order, orderBy))
              ...
              <div class="table__header-content">
                <div class="table__column">
                  <div class="table__label">
                    ...
                    <a href="" class="table__header-action" onClick={(e)=>{this.onSort(e,'name')}}>
                    <Reorder/></a>
                  </div>
                </div>
                <div class="table__search-container">
                  <input ref={this.nameInput} onChange={this.onSearch.bind(this)} type="text" id="name" class="table__search" placeholder="Search..." />
                  <TableSearch/>
                </div>
              </div>
            </th>
              ...
              <div class="table__header-content">
                <div class="table__column">
                  <div class="table__label">
                    ...
                    <a href="" class="table__header-action" onClick={(e)=>{this.onSort(e,'topic')}}>
                    <Reorder/></a>
                  </div>
                  <SvgCaretLines/>
                </div>
                <div class="table__search-container">
                  <input ref = {this.topicInput} onChange={this.onSearch.bind(this)} type="text" id="goal" class="table__search" placeholder="Search..." />
                  <TableSearch/>
                </div>
              </div>
            </th>
              ...
              <div class="table__header-content">
                <div class="table__column">
                  <div class="table__label">
                    ...
                    <a href="" class="table__header-action" onClick={(e)=>{this.onSort(e,'date')}}>
                    <Reorder/></a>
                  </div>
                </div>
              </div>
              ...
              <div class="table__header-content">
                <div class="table__column">
                  <div class="table__label">
                    ...
                    <a href="" class="table__header-action" onClick={(e)=>{this.onSort(e,'hours')}}>
                    <Reorder/></a>
                  </div>
                </div>
              </div>
