...
class SidebarComp extends Component {
    ...
    render() { 
        return ( 
            <div>
                { this.state.isAdmin ? ( <SidebarAdmin switch = {this.handleSidebarSwitch} userInfo = {this.props.selfProfileReducer}/> ) : ( <SidebarStandard switch = {this.handleSidebarSwitch} userInfo = {this.props.selfProfileReducer}/> ) } 
            </div>
        );
    }
}
