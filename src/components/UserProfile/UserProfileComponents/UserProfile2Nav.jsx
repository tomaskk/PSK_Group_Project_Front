...
export default class UserProfile2Nav extends Component {
  ...
  handleSpecialistTabClick = () => {
    if(this.props.currentState !== 'Specialist')
...
render(){
  ...
  const SpecialistClassName = this.props.currentState === 'Specialist'? activeClass : inactiveClass;
  const LearnClassName = this.props.currentState !== 'Specialist'? activeClass : inactiveClass;
    ...
    <div>
      <ul className="tabs content__fixed">
         ...
         <li><a
            ...
            className={LearnClassName} alt="learn-tab">
